...
export default class App extends React.Component {
  ...
  render() {
    ...
    return (
<UserContext.Provider value={{state:this.state,changeNavbar:this.changeNavbar,loginHandler:this.loginHandler,logoutHandler:this.logoutHandler,handleModal:this.handleModal }}>
